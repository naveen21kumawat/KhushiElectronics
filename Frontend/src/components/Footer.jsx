        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="/shop" className="text-gray-300 hover:text-blue-400 transition-colors duration-300 text-sm">
                  Shop
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="/location" className="text-gray-300 hover:text-blue-400 transition-colors duration-300 text-sm">
                  Location
                </a>
              </li>
              <li>
                <a href="/review" className="text-gray-300 hover:text-blue-400 transition-colors duration-300 text-sm">
                  Reviews
                </a>
              </li>
            </ul>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="/terms" className="text-gray-300 hover:text-blue-400 transition-colors duration-300 text-sm">
                  Terms of Service
                </a>
              </li>
              <li>
